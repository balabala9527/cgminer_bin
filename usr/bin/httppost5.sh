...
echo ", \"core1\":" >> $filename2
echo "API Command cores"
echo -n '{"command":"ascset", "parameter":"0,cores,0x00"}' | nc 127.0.0.1 4028 >> $filename2
echo ", \"core2\":" >> $filename2
echo "API Command cores"
echo -n '{"command":"ascset", "parameter":"0,cores,0x01"}' | nc 127.0.0.1 4028 >> $filename2
echo ", \"core3\":" >> $filename2
echo "API Command cores"
echo -n '{"command":"ascset", "parameter":"0,cores,0x02"}' | nc 127.0.0.1 4028 >> $filename2
#echo "}}" >> $filename2
#echo ", \"hbsn\":" >> $filename2
#echo "API Command hbsn"
#echo -n '{"command":"ascset", "parameter":"0,hbsn,null"}' | nc 127.0.0.1 4028 >> $filename2
echo "}" >> $filename2
